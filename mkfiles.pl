...
sub mfval($) {
	...
	("vc","vcproj","cygwin","borland","lcc","devcppproj","gtk","unix",
         "am","osx","vstudio10","vstudio12","vstudio15")) {
        return 1;
    }
...
if (defined $makefiles{'vstudio10'} || defined $makefiles{'vstudio12'} || defined $makefiles{'vstudio15'}) {
    ...
    sub create_vs_project {
        ...
        print
            ...
            "      <PreprocessorDefinitions>WIN32;NDEBUG;_WINDOWS;POSIX;_CRT_SECURE_NO_WARNINGS;_CRT_NONSTDC_NO_DEPRECATE;ONTHESPOT;%(PreprocessorDefinitions)</PreprocessorDefinitions>\n" .
            ...
            "      <AdditionalIncludeDirectories>" . (join ";", map {"..\\..\\$dirpfx$_"} @srcdirs) . ";%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>\n" .
            "      <PreprocessorDefinitions>WIN32;_DEBUG;_WINDOWS;POSIX;_CRT_SECURE_NO_WARNINGS;_CRT_NONSTDC_NO_DEPRECATE;ONTHESPOT;%(PreprocessorDefinitions)</PreprocessorDefinitions>\n" .
