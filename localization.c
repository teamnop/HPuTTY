...
struct localization_table table[] = {
	...
	{ "Enable legacy use of s&ingle-DES in SSH-2", L"SSH-2에서 레거시 Single-DES 사용 허용(&I)" },
	...
	{ "Don't allocate a &pseudo-terminal", L"가상 터미널 할당 안함(&P)" },
	{ "Terminal modes to send:", L"서버로 보낼 터미널 모드 값:" },
	{ "&Mode:", L"모드(&M):" },
	{ "Value:", L"값:" },
	{ "This:", L"지정값:" },
	{ "Terminal modes", L"터미널 모드 목록" },
	{ "Remote terminal settings", L"원격 터미널 설정" },
