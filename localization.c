...
struct localization_table table[] = {
	...
	{ "Tunnels", L"Tunnels" },
	{ "Bugs", L"Bugs" },
	{ "More bugs", L"More bugs" },
	{ "Serial", L"Serial" },
	{ "Cygterm", L"Cygterm" },
	{ "Host &Name (or IP address)", L"Host &Name (or IP address)" },
	{ "&Port", L"&Port" },
	{ "Connection type:", L"Connection type:" },
	{ "Ra&w", L"Ra&w" },
	{ "Ad&b", L"Ad&b" },
	{ "&Telnet", L"&Telnet" },
	{ "Rlog&in", L"Rlog&in" },
	...
	{ "Se&rial", L"Se&rial" },
	{ "Cygterm", L"Cygterm" },
	{ "Specify the destination you want to connect to", L"Specify the destination you want to connect to" },
	{ "Sav&ed Sessions", L"Sav&ed Sessions" },
	{ "&Load", L"&Load" },
	{ "Sa&ve", L"Sa&ve" },
	{ "&Delete", L"&Delete" },
	{ "Sessions from registry", L"Sessions from registry" },
	{ "Sessions from file", L"Sessions from file" },
	{ "Load, save or delete a stored session", L"Load, save or delete a stored session" },
	{ "Close window on e&xit:", L"Close window on e&xit:" },
	{ "Always", L"Always" },
	{ "Never", L"Never" },
	{ "Only on clean exit", L"Only on clean exit" },
	{ "UI Language (requires restart):", L"언어 (재시작 필요):" },
	{ "English", L"English" },
	{ "Korean", L"Korean" },
	{ "Basic options for your PuTTY session", L"Basic options for your PuTTY session" },
	{ "Session logging:", L"Session logging:" },
	{ "None", L"None" },
	{ "&Printable output", L"&Printable output" },
	{ "A&ll session output", L"A&ll session output" },
	{ "&SSH packets", L"&SSH packets" },
	{ "SSH packets and &raw data", L"SSH packets and &raw data" },
	{ "Log &file name:", L"Log &file name:" },
	{ "Bro&wse...", L"Bro&wse..." },
